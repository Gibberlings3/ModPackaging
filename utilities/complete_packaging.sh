...
dotnet "$(dirname $0)/md2html/md2html.dll" -f "https://gibberlings3.github.io/Documentation/readmes/style/g3icon.ico" -s "https://gibberlings3.github.io/Documentation/readmes/style/g3md.css" -o "${mod_folder}" .
